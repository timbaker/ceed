...
def declare(actionManager):
    ...
    cat.createAction(name = "edit_offsets", label = "Edit &Offsets",
                     help = "When you select an image definition, a crosshair will appear in it representing it's offset centrepoint.",
    ...
    cat.createAction(name = "cycle_overlapping", label = "Cycle O&verlapping Image Definitions",
                     help = "When images definition overlap in such a way that makes it hard/impossible to select the definition you want, this allows you to select on of them and then just cycle until the right one is selected.",
    ...
    cat.createAction(name = "create_image", label = "&Create Image Definition",
                     help = "Creates a new image definition at the current cursor position, sized 50x50 pixels.",
    ...
    cat.createAction(name = "duplicate_image", label = "&Duplicate Image Definition",
                     help = "Duplicates selected image definitions.",
    ...
    cat.createAction(name = "focus_image_list_filter_box", label = "&Focus Image Definition List Filter Box",
                     help = "This allows you to easily press a shortcut and immediately search through image definitions without having to reach for a mouse.",
